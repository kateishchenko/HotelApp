...
export class Payment extends Component{
    ...
    editClick(pay){
        this.setState({
            ...
            ReservationID:pay.ReseravtionID
        });
    }
    ...
    createClick(){
        fetch(variables.API_URL+'payment',{
            ...
            body:JSON.stringify({
                ...
                ReseravtionID:this.state.ReservationID
            })
        })
        .then(res=>res.json())
        .then((result)=>{
    ...
    deleteClick(id){
        ...
        fetch(variables.API_URL+'payment/'+id,{
            method:'DELETE',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
    ...
    <tbody>
        {payments.map(pay=>
             ...
             onClick={()=>this.editClick(pay)}>
                ...
                <button type="button"
                className="btn btn-light mr-1"
                onClick={()=>this.deleteClick(pay.PaymentID)}>
